    ...
    <Container 
      ...
      <Card 
        ...
        <CardContent sx={{
          ...
          <Typography sx={{mt: 0.4, ml: 1, color: "#ffffff"}} variant="body2">
            {event.date}
          </Typography>
        </CardContent>
        ...
        <Collapse in={expandedId === i} timeout="auto" unmountOnExit>
          <CardContent>
            <Typography paragraph color="branquinha">{event.description}</Typography>
          </CardContent>
        </Collapse>
      </Card>
      ))}
